...
// AnyToBool converts anything to bool
func AnyToBool(input interface{}) (res bool) {
	val := AnyToString(input)
	res, _ = strconv.ParseBool(val)

	return
}

// AnyToInt converts anything to integer
func AnyToInt(input interface{}) (res int) {
	switch input := input.(type) {
